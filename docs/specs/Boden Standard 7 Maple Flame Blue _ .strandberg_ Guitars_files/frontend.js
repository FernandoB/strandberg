...
return false;}
try{var supports_html5_storage=('sessionStorage'in window&&window['sessionStorage']!==null);if(supports_html5_storage&&get_cookie('aelia_user_logged_in')){var fragment_name='wc_fragments';if(wc_cart_fragments_params&&wc_cart_fragments_params.fragment_name){fragment_name=wc_cart_fragments_params.fragment_name;}
